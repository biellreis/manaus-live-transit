...
await sharp('../client/public/ICONE-APLICATIVO.png').resize(32,32).png().toFile('public/brand/favicon-32x32.png');
await sharp('../client/public/ICONE-APLICATIVO.png').resize(192,192).png().toFile('public/brand/favicon.png');
await sharp('../client/public/ICONE-APLICATIVO.png').resize(180,180).png().toFile('public/brand/apple-touch-icon.png');
